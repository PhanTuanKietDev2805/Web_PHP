          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              ...
              <?php
                  ...
                  $sql_cate_home = mysqli_query($con, "SELECT * FROM tbl_category, tbl_sanpham WHERE tbl_category.category_id = tbl_sanpham.category_id  AND tinhtrang = 1 ORDER BY tbl_sanpham.sanpham_id DESC LIMIT $perRow, $rowPerPage");
                  $totalRow=mysqli_num_rows(mysqli_query($con, "SELECT * FROM tbl_category, tbl_sanpham WHERE tbl_category.category_id = tbl_sanpham.category_id  AND tinhtrang = 1 ORDER BY tbl_sanpham.sanpham_id"));
                  ...
                  for($i=1;$i<=$totalPage;$i++){
                    if($page==$i){
                        $list_page.='<li class="active"><a href="?quanly=sanpham&page='.$i.'" >'.$i.'</a></li>';
                    }else{
                        $list_page.='<li><a href="?quanly=sanpham&page='.$i.'">'.$i.'</a></li>';
                    }
                }
                if ( $page > 1)
                {
                  $i  =  $page - 1;
                  $prev.='<li><a href="?quanly=sanpham&page='.$i.'">&lt;</a></li>';

                  $first.='<li><a href="?quanly=sanpham&page=1">«</a></li>';
                }

                if ( $page < $totalPage)
                {
                  $i  =  $page + 1;
                  $next.='<li><a href="?quanly=sanpham&page='.$i.'">&gt;</a></li>';

                  $last.='<li><a href="?quanly=sanpham&page='.$totalPage.'">»</a></li>';
                }
