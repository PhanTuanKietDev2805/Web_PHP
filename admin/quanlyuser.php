    ...
    <!-- Right Panel -->
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
				...
				$sql_select_khachhang = mysqli_query($con,"SELECT * FROM tbl_khachhang WHERE khachhang_id  ORDER BY khachhang_id DESC LIMIT $perPage,$rowPerPage"); 
                $totalRows=mysqli_num_rows(mysqli_query($con,"SELECT * FROM tbl_khachhang WHERE khachhang_id  ORDER BY khachhang_id DESC"));
                ...
                for($i=1;$i<=$totalPages;$i++)
                 {
                     if($page==$i){
                         $list_page.='<li class="active"><a href="quanlyuser.php?&page='.$i.'">'.$i.'</a></li>';
                     }
                     else{
                         $list_page.='<li><a href="quanlyuser.php?&page='.$i.'">'.$i.'</a></li>';
                     }
                 }
                 if ( $page > 1)
                {
                  $i  =  $page - 1;
                  $prev.='<li><a href="quanlyuser.php?&page='.$i.'">&lt;</a></li>';

                  $first.='<li><a href="quanlyuser.php?&page=1">«</a></li>';
                }

                if ( $page < $totalPages)
                {
                  $i  =  $page + 1;
                  $next.='<li><a href="quanlyuser.php?&page='.$i.'">&gt;</a></li>';

                  $last.='<li><a href="quanlyuser.php?&page='.$totalPages.'">»</a></li>';
                }
				?> 
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><?php echo $row_khachhang['trangthai'] ?></td>
						<td><a href="capnhatuser.php?&capnhat_id=<?php echo $row_khachhang['khachhang_id'] ?>">Update</a></td>
					</tr>
					 <?php
					} 
					?> 
				</table>
                <a href="themuser.php" class="btn btn-primary" style="margin: 10px 0 20px 0; ">Add </a>
			</div>
