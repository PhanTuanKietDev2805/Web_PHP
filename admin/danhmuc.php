        ...
        <!-- /#header -->
         ...
         <div class="content">
            ...
            <div class="animated fadeIn">
				...
				$sql_select = mysqli_query($con,"SELECT * FROM tbl_category ORDER BY category_id DESC LIMIT $perPage,$rowPerPage"); 
                $totalRows=mysqli_num_rows(mysqli_query($con, "SELECT * FROM tbl_category"));
                 ...
                 {
                     if($page==$i){
                         $list_page.='<li class="active"><a href="danhmuc.php?&page='.$i.'">'.$i.'</a></li>';
                     }
                     else{
                         $list_page.='<li><a href="danhmuc.php?&page='.$i.'">'.$i.'</a></li>';
                     }
                 }
                 if ( $page > 1)
                {
                  $i  =  $page - 1;
                  $prev.='<li><a href="danhmuc.php?&page='.$i.'">&lt;</a></li>';

                  $first.='<li><a href="danhmuc.php?&page=1">«</a></li>';
                }

                if ( $page < $totalPages)
                {
                  $i  =  $page + 1;
                  $next.='<li><a href="danhmuc.php?&page='.$i.'">&gt;</a></li>';

                  $last.='<li><a href="danhmuc.php?&page='.$totalPages.'">»</a></li>';
                }
				?> 
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a onclick="return xoadanhmuc();" href="?xoa=<?php echo $row_category['category_id'] ?>">Delete</a> || <a href="capnhatdanhmuc.php?&id=<?php echo $row_category['category_id'] ?>">Update</a></td>
					</tr>
					<?php
					} 
					?>
				</table>
                <a href="themdanhmuc.php" class="btn btn-primary" style="margin: 10px 0 20px 0; ">Add New Category</a>
